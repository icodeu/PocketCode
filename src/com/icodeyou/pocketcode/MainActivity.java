...
public class MainActivity extends Activity implements
	...
	private Handler getCategoryHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			try {
				...
				for (int i = 0; i < jsonArray.length(); i++) {
					JSONObject object = jsonArray.getJSONObject(i);
					categoryList.add(new Category(object.getString("category_id"),
			...
			mDrawerList.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					HttpUtils getJsonHttpUtils = new HttpUtils(WEB_PATH+"getLesson.php?category_id=" + category.getCategory_id(), getJsonHandler);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		HttpUtils getJsonHttpUtils = new HttpUtils(WEB_PATH+"getLesson.php", getJsonHandler);
		getJsonHttpUtils.getJsonString();
		
		HttpUtils getCategoryHttpUtils = new HttpUtils(WEB_PATH+"getCategory.php", getCategoryHandler);
